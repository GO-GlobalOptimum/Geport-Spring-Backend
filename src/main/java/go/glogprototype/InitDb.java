...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            Post post1 = createPost("hi", 0, "spring study is good",true,0,"hihi","local/image",true,0,localDateTime);
            em.persist(post1);
            Post post2 = createPost("hi2", 0, "spring study is good2",true,0,"hihi2","local/image2",true,0,localDateTime);
            em.persist(post2);
        ...
        public void dbInit2() {
            LocalDateTime localDateTime = LocalDateTime.now();
            Member member = createMember("userB", "example2@gmail.com", "ss", Authority.USER,"example2@naver.com",localDateTime);
            em.persist(member);
        ...
        private Post createPost(String title,int viewCount, String postContent,boolean isPublic, int likeCount, String text, String imageUrl, boolean isComment,int commentCount ,LocalDateTime createDate  ){
            Post post = new Post();
